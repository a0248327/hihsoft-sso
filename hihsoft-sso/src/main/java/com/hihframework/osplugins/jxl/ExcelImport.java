...
public abstract class ExcelImport {
	...
	public String getContents(int col, int row) {
		...
		if (sheet != null) {
			...
			//
			// return
			// Double.toString(Math.round(numcell.getValue()));
			//
			// } else {
			// return cell.getContents();
			// }
	 ...
	 * @return 创建过的工作表
	 */
	public WritableSheet getWritableSheet(String sheetName, int sheetNo) throws Exception {
	 ...
	 *                要插入的字符串
	 */
	public boolean addString(int column, int row, String label) throws Exception {
