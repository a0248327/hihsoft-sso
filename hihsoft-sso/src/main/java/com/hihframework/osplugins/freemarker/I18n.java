...
/**
 * <p>
 * Title:国际化处理类：包括所有的Freemarker页面上语言参数的提取
 * </p>
 * <p>
 * Description:解决新闻模板中涉及的属性文件的读值
 * </p>
 * <p>
...
public class I18n {
	...
	private static void loadLocales() {
		...
		try {
			fis = I18n.class.getClassLoader().getResourceAsStream("resources/FreeMarker.properties");
	...
	public static Map<String, Object> getMessage() {
		...
		for (Object key : keySet) {
			messagesMap.put((String) key, localeNames.getProperty((String) key));
		}
		return messagesMap;
