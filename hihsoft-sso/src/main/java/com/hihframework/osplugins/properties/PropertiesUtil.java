...
public class PropertiesUtil {
	...
	static ResourceBundle rb = ResourceBundle.getBundle("resources.propertiescfg.SystemGlobals");
	static ResourceBundle app = ResourceBundle.getBundle("resources.propertiescfg.ApplicationResources");
