...
public class PinYinUtil {
	...
	/**
	 * Gets the pin yin. 传入中文汉字，转换出对应拼音 注：出现同音字，默认选择汉字全拼的第一种读音
	 * 
	 * @param src
	 *                the src
	 * @return the pin yin
	 ...
	 * @param src
	 *                the src
	 * @return the pin yin Description ： 将单个汉字转换成汉语拼音，考虑到同音字问题，返回字符串数组的形式
	 */
	 ...
	 * @param src
	 *                the src
	 * @return the no polyphone Description ： 传入没有多音字的中文汉字，转换出对应拼音
