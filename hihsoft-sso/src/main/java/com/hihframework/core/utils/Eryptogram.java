...
public class Eryptogram {
	public static final Logger log = Logger.getLogger(Eryptogram.class.getName());
	...
	// String encryptResultStr = parseByte2HexStr(encrypt(content,
	// password));
