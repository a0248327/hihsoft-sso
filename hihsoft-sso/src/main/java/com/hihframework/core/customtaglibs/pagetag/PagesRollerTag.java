...
public class PagesRollerTag extends TagBase {
	...
	public int doStartTag() throws JspException {
		...
		pageContext.setAttribute("url", String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));
		...
		pageContext.setAttribute(Consts.SYS_PAGE_NO, "".concat(String.valueOf(String.valueOf(count))));
		pageContext.setAttribute("sumpages", "".concat(String.valueOf(String.valueOf(sumPages))));
		...
		pageContext.setAttribute("firsturl", String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));

		paramTable.put(Consts.SYS_PAGE_NO, "".concat(String.valueOf(String.valueOf(sumPages))));
		// pageContext.setAttribute("lasturl",
		// String.valueOf(request.getRequestURI()) +
		// String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));
		pageContext.setAttribute("lasturl", String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));

		if (count > 1) {
			pageContext.setAttribute("hasprev", "true");
			paramTable.put(Consts.SYS_PAGE_NO, String.valueOf(String.valueOf(count - 1)).concat(""));
			// pageContext.setAttribute("prevurl",
			// String.valueOf(request.getRequestURI()) +
			// String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));
			pageContext.setAttribute("prevurl", String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));
		...
		if (count < sumPages) {
			paramTable.put(Consts.SYS_PAGE_NO, String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(count + 1)))).append(""))));
			pageContext.setAttribute("hasnext", "true");
			// pageContext.setAttribute("nexturl",
			// String.valueOf(request.getRequestURI()) +
			// String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));
			pageContext.setAttribute("nexturl", String.valueOf(HTMLEncoder.encodeUrlParameters(paramTable)));
