...
/**
	 ...
	 * It is assumed that given string represents tag's body. Note:
	 * attribute <b>must</b> end with the <code>="</code> or <code>='</code>
	 ...
	 * parameters must define tags body. Note: attribute <b>must</b> end
	 * with the <code>="</code> or <code>='</code>. Attribute name is not
	 * case sensitive.
	 *
	 * @param body
	 *                html body
	...
	/**
	 * Adds attribute and its value to a tag. Attribute is added to the end
	 * of the tag, just before closing '>'. If name is not specified,
	 * nothing will be added. If value is not specified, it will be set to
	 * an empty string.
	 *
	 * @param tagBody
	 *                tag body
	...
	/**
	 * Adds single attribute without value to a tag. Attribute is added to
	 * the end of the tag, just before closing '>'. If name is not
	 * specified, nothing will be added.
	 *
	 * @param tagBody
	 *                tag body
	 * @param name
