...
public class TlogDbsql extends BaseEntity {
	...
	public TlogDbsql(java.lang.String databaseOid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("DatabaseOid", getDatabaseOid()).append("TableName", getTableName()).append("TableOperate", getTableOperate())
				.append("TableAccessTimes", getTableAccessTimes()).append("TableAccessLastTime", getTableAccessLastTime()).append("Columes", getColumes())
				.append("Userid", getUserid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getDatabaseOid()).append(getTableName()).append(getTableOperate()).append(getTableAccessTimes()).append(getTableAccessLastTime())
				.append(getColumes()).append(getUserid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TlogDbsql == false)
			return false;
		if (this == obj)
			return true;
		TlogDbsql other = (TlogDbsql) obj;
		return new EqualsBuilder().append(getDatabaseOid(), other.getDatabaseOid()).append(getTableName(), other.getTableName()).append(getTableOperate(), other.getTableOperate())
				.append(getTableAccessTimes(), other.getTableAccessTimes()).append(getTableAccessLastTime(), other.getTableAccessLastTime()).append(getColumes(), other.getColumes())
