...
public interface TlogServicecallService extends BaseService {
	...
	public int getTlogServicecallDataTotalNum(String hql, Object[] object) throws ServiceException;
	...
	public List<?> getTlogServicecallPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogServicecallPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTlogServicecallValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTlogServicecallValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
