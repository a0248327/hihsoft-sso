...
public class TlogLoginlog extends BaseEntity {
	...
	public TlogLoginlog(java.lang.String logid) {
		this.logid = logid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Logid", getLogid()).append("Ipaddr", getIpaddr()).append("Logintime", getLogintime()).append("Logouttime", getLogouttime())
				.append("Onlinetime", getOnlinetime()).append("Userid", getUserid()).append("Logout", getLogout()).append("Orgid", getOrgid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getLogid()).append(getIpaddr()).append(getLogintime()).append(getLogouttime()).append(getOnlinetime()).append(getUserid()).append(getLogout())
				.append(getOrgid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TlogLoginlog == false)
			return false;
		if (this == obj)
			return true;
		TlogLoginlog other = (TlogLoginlog) obj;
		return new EqualsBuilder().append(getLogid(), other.getLogid()).append(getIpaddr(), other.getIpaddr()).append(getLogintime(), other.getLogintime())
				.append(getLogouttime(), other.getLogouttime()).append(getOnlinetime(), other.getOnlinetime()).append(getUserid(), other.getUserid())
				.append(getLogout(), other.getLogout()).append(getOrgid(), other.getOrgid()).isEquals();
	}
}
