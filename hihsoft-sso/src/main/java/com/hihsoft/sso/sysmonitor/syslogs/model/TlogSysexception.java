...
public class TlogSysexception extends BaseEntity {
	...
	public TlogSysexception(java.lang.String exceptionOid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("ExceptionOid", getExceptionOid()).append("ExceptionTimes", getExceptionTimes()).append("ExceptionLasttime", getExceptionLasttime())
				.append("ExceptionName", getExceptionName()).append("ExceptionMsg", getExceptionMsg()).append("ExceptionClass", getExceptionClass()).append("Userid", getUserid())
				.toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getExceptionOid()).append(getExceptionTimes()).append(getExceptionLasttime()).append(getExceptionName()).append(getExceptionMsg())
				.append(getExceptionClass()).append(getUserid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TlogSysexception == false)
			return false;
		if (this == obj)
			return true;
		TlogSysexception other = (TlogSysexception) obj;
		return new EqualsBuilder().append(getExceptionOid(), other.getExceptionOid()).append(getExceptionTimes(), other.getExceptionTimes())
				.append(getExceptionLasttime(), other.getExceptionLasttime()).append(getExceptionName(), other.getExceptionName()).append(getExceptionMsg(), other.getExceptionMsg())
				.append(getExceptionClass(), other.getExceptionClass()).append(getUserid(), other.getUserid()).isEquals();
	}
}
