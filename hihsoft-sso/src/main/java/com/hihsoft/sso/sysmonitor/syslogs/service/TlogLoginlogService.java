...
public interface TlogLoginlogService extends BaseService {
	...
	public int getTlogLoginlogDataTotalNum(String hql, Object[] object) throws ServiceException;
	...
	public List<?> getTlogLoginlogPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogLoginlogPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTlogLoginlogValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTlogLoginlogValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
