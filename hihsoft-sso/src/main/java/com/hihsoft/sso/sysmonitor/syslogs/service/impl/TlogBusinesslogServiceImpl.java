...
/**
 * Title: Description: Copyright: Copyright (c) 2011 Company:javahih.co.,ltd
 * 
 * @author zhujw
 * @version 1.0
 */
...
public class TlogBusinesslogServiceImpl extends BaseServiceImpl implements TlogBusinesslogService {
	...
	public int getTlogBusinesslogDataTotalNum(String hql, Object[] object) throws ServiceException {
	...
	public List<?> getTlogBusinesslogPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogBusinesslogPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException {
	 ...
	 */
	public List<?> getTlogBusinesslogValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTlogBusinesslogValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
