...
public interface TlogSysexceptionService extends BaseService {
	...
	public int getTlogSysexceptionDataTotalNum(String hql, Object[] object) throws ServiceException;
	...
	public List<?> getTlogSysexceptionPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogSysexceptionPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTlogSysexceptionValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTlogSysexceptionValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
