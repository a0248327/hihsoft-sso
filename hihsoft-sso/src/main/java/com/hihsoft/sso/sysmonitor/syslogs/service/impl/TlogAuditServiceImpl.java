...
public class TlogAuditServiceImpl extends BaseServiceImpl implements TlogAuditService {
	/************ 查询所有的TLOGAUDIT ******************/
	...
	private static final StringBuffer QUERY_TLOGAUDIT_HQL = new StringBuffer(" from TlogAudit tlogAudit where 1=1");

	/************ 通过不同的条件组合，利用JDBC SQL查询TLOGAUDIT ******************/
	private static final StringBuffer QUERY_TLOGAUDIT_SQL = new StringBuffer("select * from T_LOG_AUDIT t where 1=1");
	 ...
	 */
	public void saveOrUpdateTlogAudit(TlogAudit tlogAudit) throws ServiceException {
	...
	public TlogAudit getTlogAuditById(String id) throws ServiceException {
		...
		List<?> list = baseDAO.getValueObjectsByHQL(TLOGAUDITById_HQL, new Object[] { id });
	...
	public List<?> getTlogAuditByArray(Object[] filter) throws ServiceException {
		return baseDAO.getValueObjectsByHQL(QUERY_TLOGAUDIT_HQL.toString(), filter);
	}
	...
	public int getTlogAuditDataTotalNum(Object[] filter) throws ServiceException {
	...
	public List<?> getTlogAuditPageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TLOGAUDIT_HQL.toString(), filter, page_size, pageNo);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogAuditPageDataByMap(Map<String, Object> filter, int page_size, int pageNo) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TLOGAUDIT_HQL.toString(), filter, page_size, pageNo);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogAuditValueObjectWithSQLByArray(Object[] filter) throws ServiceException {
		return baseDAO.getValueObjectBySQL(QUERY_TLOGAUDIT_SQL.toString(), filter);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogAuditValueObjectByNameQuery(String queryName, Object[] filter) throws ServiceException {
	 ...
	 */
	public List<?> getTlogAuditValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTlogAuditValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
