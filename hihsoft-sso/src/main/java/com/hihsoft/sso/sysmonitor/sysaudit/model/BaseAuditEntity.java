...
/**
 * <p>
 * Title: 面向对象的值对象传递：所有实体类的基类 Description:公共属性 Copyright: Copyright (c) 2013
 * Company:hihsoft.co.,ltd
 * 
 * @author hihsoft.co.,ltd
 * @version 1.0
 */
public class BaseAuditEntity implements Serializable, Cloneable, HistorizableEntity {
