...
public class TlogBusinesslog extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Logid", getLogid()).append("CreateDate", getCreateDate()).append("Custip", getCustip()).append("Moduleid", getModuleid())
				.append("Operateid", getOperateid()).append("Orgid", getOrgid()).append("Userid", getUserid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getLogid()).append(getCreateDate()).append(getCustip()).append(getModuleid()).append(getOperateid()).append(getOrgid()).append(getUserid())
				.toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getLogid(), other.getLogid()).append(getCreateDate(), other.getCreateDate()).append(getCustip(), other.getCustip())
				.append(getModuleid(), other.getModuleid()).append(getOperateid(), other.getOperateid()).append(getOrgid(), other.getOrgid()).append(getUserid(), other.getUserid())
				.isEquals();
	}
}
