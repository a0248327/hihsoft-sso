...
public class TlogServicecall extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Callid", getCallid()).append("ServiceClass", getServiceClass()).append("Userid", getUserid()).append("MethodName", getMethodName())
				.append("ConsumeTime", getConsumeTime()).append("CallTime", getCallTime()).toString();
	}
	...
	public boolean equals(final Object obj) {
		...
		return new EqualsBuilder().append(getCallid(), other.getCallid()).append(getServiceClass(), other.getServiceClass()).append(getUserid(), other.getUserid())
				.append(getMethodName(), other.getMethodName()).append(getConsumeTime(), other.getConsumeTime()).append(getCallTime(), other.getCallTime()).isEquals();
	}
}
