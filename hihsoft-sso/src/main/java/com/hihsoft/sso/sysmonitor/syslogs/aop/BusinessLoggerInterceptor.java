...
public class BusinessLoggerInterceptor extends HandlerInterceptorAdapter {
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
		...
		if ((StringUtils.startsWithIgnoreCase(requestRri, uriPrefix) && (StringUtils.endsWithIgnoreCase(requestRri, "/save") || StringUtils.endsWithIgnoreCase(requestRri, "/delete")
				|| StringUtils.endsWithIgnoreCase(requestRri, "/edit") || StringUtils.endsWithIgnoreCase(requestRri, "/update")))
				|| !StringUtils.endsWithIgnoreCase(requestRri, "index.jsp") || !StringUtils.endsWithIgnoreCase(uriPrefix, "/tsysLoginController.do")) {
			log.info("还报错，啥情况");
		}
