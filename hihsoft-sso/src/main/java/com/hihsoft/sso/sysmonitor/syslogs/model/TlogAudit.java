...
public class TlogAudit extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Aduitid", getAduitid()).append("Oid", getOid()).append("BehindData", getBehindData()).append("FrontData", getFrontData())
				.append("CreateUser", getCreateUser()).append("CreateTime", getCreateTime()).append("ModifyMan", getModifyMan()).append("ModifyTime", getModifyTime())
				.append("Property", getProperty()).append("OperationType", getOperationType()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getAduitid()).append(getOid()).append(getBehindData()).append(getFrontData()).append(getCreateUser()).append(getCreateTime())
				.append(getModifyMan()).append(getModifyTime()).append(getProperty()).append(getOperationType()).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getAduitid(), other.getAduitid()).append(getOid(), other.getOid()).append(getBehindData(), other.getBehindData())
				.append(getFrontData(), other.getFrontData()).append(getCreateUser(), other.getCreateUser()).append(getCreateTime(), other.getCreateTime())
				.append(getModifyMan(), other.getModifyMan()).append(getModifyTime(), other.getModifyTime()).append(getProperty(), other.getProperty())
				.append(getOperationType(), other.getOperationType()).isEquals();
	}
}
