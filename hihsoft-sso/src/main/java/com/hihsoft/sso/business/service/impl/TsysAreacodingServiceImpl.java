...
public class TsysAreacodingServiceImpl extends BaseServiceImpl implements TsysAreacodingService {
	/************ 查询所有的TSYSAREACODING ******************/
	...
	public TsysAreacoding getTsysAreacodingById(String id) throws ServiceException {
		...
		List<?> list = baseDAO.getValueObjectsByHQL(TSYSAREACODINGById_HQL, new Object[] { id });
	...
	public int getTsysAreacodingDataTotalNum(String hql, Object[] object) throws ServiceException {
	...
	public List<?> getTsysAreacodingPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysAreacodingPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException {
	 ...
	 */
	public List<?> getTsysAreacodingValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysAreacodingValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
