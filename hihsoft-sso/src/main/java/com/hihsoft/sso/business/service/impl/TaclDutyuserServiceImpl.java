...
public class TaclDutyuserServiceImpl extends BaseServiceImpl implements TaclDutyuserService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.hihsoft.sso.business.service.TaclDutyuserService#
	 * saveOrUpdateTaclDutyuser(com.hihsoft.sso.business.model.TaclDutyuser)
	 */
	@Override
	public void saveOrUpdateTaclDutyuser(TaclDutyuser taclDutyuser) throws ServiceException {
	 ...
	 * 
	 * @see
	 * com.hihsoft.sso.business.service.TaclDutyuserService#deleteTaclDutyuser
	 * (java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.hihsoft.sso.business.service.TaclDutyuserService#getTaclDutyuserById
	 * (java.lang.String)
	 */
	@Override
	public TaclDutyuser getTaclDutyuserById(String id) throws ServiceException {
		TaclDutyuser taclDutyuser = null;
		List<?> list = baseDAO.getValueObjectsByHQL(TACLDUTYUSERById_HQL, new Object[] { id });
