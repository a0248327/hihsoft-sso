...
/**
 * Title:附件上传的控制层服务 Description: Copyright: Copyright (c) 2013
...
public class FileUploadController extends javahihBaseController {
	...
	public ModelAndView forward(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
		...
		for (TsysUpload up : list) {
			...
			if (StringHelpers.isNull(curflat))
				continue;
	...
	public ModelAndView rename(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
