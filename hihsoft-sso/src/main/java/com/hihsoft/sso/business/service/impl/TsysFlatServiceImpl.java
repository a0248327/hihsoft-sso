...
public class TsysFlatServiceImpl extends BaseServiceImpl implements TsysFlatService {
	/************ 查询所有的TSYSFLAT ******************/
	...
	private static final StringBuffer QUERY_TSYSFLAT_HQL = new StringBuffer(" from TsysFlat tsysFlat where 1=1");

	/************ 通过不同的条件组合，利用JDBC SQL查询TSYSFLAT ******************/
	private static final StringBuffer QUERY_TSYSFLAT_SQL = new StringBuffer("select * from T_SYS_FLAT t where 1=1");
	...
	public TsysFlat getTsysFlatById(String id) throws ServiceException {
		...
		List<?> list = baseDAO.getValueObjectsByHQL(TSYSFLATById_HQL, new Object[] { id });
	...
	public List<?> getTsysFlatByArray(Object[] filter) throws ServiceException {
		return baseDAO.getValueObjectsByHQL(QUERY_TSYSFLAT_HQL.toString(), filter);
	}
	...
	public List<?> getTsysFlatPageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TSYSFLAT_HQL.toString(), filter, page_size, pageNo);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysFlatPageDataByMap(Map<String, Object> filter, int page_size, int pageNo) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TSYSFLAT_HQL.toString(), filter, page_size, pageNo);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysFlatValueObjectWithSQLByArray(Object[] filter) throws ServiceException {
		return baseDAO.getValueObjectBySQL(QUERY_TSYSFLAT_SQL.toString(), filter);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysFlatValueObjectByNameQuery(String queryName, Object[] filter) throws ServiceException {
	 ...
	 */
	public List<?> getTsysFlatValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysFlatValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
	...
	public List<Map<String, Object>> getFlatsList(String flatname, String orders, int rows, int page) throws ServiceException {
		...
		String order = "";
		if (StringHelpers.notNull(flatname))
			querysql += " and flatname like '%" + flatname + "%'";
		if (StringHelpers.notNull(orders))
