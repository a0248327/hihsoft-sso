...
/**
 * Title:数据权限的服务 Description: Copyright: Copyright (c) 2013
...
public interface TsysDataprivilegeService extends BaseService {
	...
	public int getTsysDataprivilegeDataTotalNum(Object[] filter) throws ServiceException;
	...
	public List<?> getTsysDataprivilegePageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysDataprivilegePageDataByMap(Map<String, Object> filter, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTsysDataprivilegeValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysDataprivilegeValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
