...
public class TbusinessOrder extends BaseEntity {
	...
	public static final String FORMAT_PURCHASE_DATE = DateUtils.getDatePattern();
	...
	public String getAppointmentTimeString() {
		if (getAppointmentTime() != null)
			return DateUtils.format(getAppointmentTime(), FORMAT_APPOINTMENT_TIME);
		else
			return null;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Id", getId()).append("Applyname", getApplyname()).append("Orderid", getOrderid()).append("AppointmentTime", getAppointmentTime())
				.append("OrderingTime", getOrderingTime()).append("Upperorderid", getUpperorderid()).append("CustomName", getCustomName()).append("CustomPhone", getCustomPhone())
				.append("CustomAddress", getCustomAddress()).append("FailurePhenomenon", getFailurePhenomenon()).append("ProductBrand", getProductBrand())
				.append("ProductType", getProductType()).append("ProductSubtype", getProductSubtype()).append("ProductModel", getProductModel())
				.append("ProductColor", getProductColor()).append("PurchaseDate", getPurchaseDate()).append("PurchaseCount", getPurchaseCount())
				.append("RepairmanId", getRepairmanId()).append("RepairMeasures", getRepairMeasures()).append("RepairMoney", getRepairMoney())
				.append("RepairPartsImages", getRepairPartsImages()).append("InvoiceImages", getInvoiceImages()).append("BarCodes", getBarCodes())
				.append("RepairedTime", getRepairedTime()).append("PaymentTime", getPaymentTime()).append("CancelPerson", getCancelPerson()).append("CancelTime", getCancelTime())
				.append("ExportPerson", getExportPerson()).append("ExportTime", getExportTime()).append("VerifyPerson", getVerifyPerson()).append("VerifyTime", getVerifyTime())
				.append("OrderState", getOrderState()).append("UserSatisfaction", getUserSatisfaction()).append("IsWarranty", getIsWarranty()).append("OrderType", getOrderType())
				.append("Within24Hours", getWithin24Hours()).append("BasicSalary", getBasicSalary()).append("PositiveIncentive", getPositiveIncentive())
				.append("NegativeIncentive", getNegativeIncentive()).append("AppreciationComponents", getAppreciationComponents()).append("AppreciationMoney", getAppreciationMoney())
				.toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getId()).append(getApplyname()).append(getOrderid()).append(getAppointmentTime()).append(getOrderingTime()).append(getUpperorderid())
				.append(getCustomName()).append(getCustomPhone()).append(getCustomAddress()).append(getFailurePhenomenon()).append(getProductBrand()).append(getProductType())
				.append(getProductSubtype()).append(getProductModel()).append(getProductColor()).append(getPurchaseDate()).append(getPurchaseCount()).append(getRepairmanId())
				.append(getRepairMeasures()).append(getRepairMoney()).append(getRepairPartsImages()).append(getInvoiceImages()).append(getBarCodes()).append(getRepairedTime())
				.append(getPaymentTime()).append(getCancelPerson()).append(getCancelTime()).append(getExportPerson()).append(getExportTime()).append(getVerifyPerson())
				.append(getVerifyTime()).append(getOrderState()).append(getUserSatisfaction()).append(getIsWarranty()).append(getOrderType()).append(getWithin24Hours())
				.append(getBasicSalary()).append(getPositiveIncentive()).append(getNegativeIncentive()).append(getAppreciationComponents()).append(getAppreciationMoney()).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getId(), other.getId()).append(getApplyname(), other.getApplyname()).append(getOrderid(), other.getOrderid())
				.append(getAppointmentTime(), other.getAppointmentTime()).append(getOrderingTime(), other.getOrderingTime()).append(getUpperorderid(), other.getUpperorderid())
				.append(getCustomName(), other.getCustomName()).append(getCustomPhone(), other.getCustomPhone()).append(getCustomAddress(), other.getCustomAddress())
				.append(getFailurePhenomenon(), other.getFailurePhenomenon()).append(getProductBrand(), other.getProductBrand()).append(getProductType(), other.getProductType())
				.append(getProductSubtype(), other.getProductSubtype()).append(getProductModel(), other.getProductModel()).append(getProductColor(), other.getProductColor())
				.append(getPurchaseDate(), other.getPurchaseDate()).append(getPurchaseCount(), other.getPurchaseCount()).append(getRepairmanId(), other.getRepairmanId())
				.append(getRepairMeasures(), other.getRepairMeasures()).append(getRepairMoney(), other.getRepairMoney()).append(getRepairPartsImages(), other.getRepairPartsImages())
				.append(getInvoiceImages(), other.getInvoiceImages()).append(getBarCodes(), other.getBarCodes()).append(getRepairedTime(), other.getRepairedTime())
				.append(getPaymentTime(), other.getPaymentTime()).append(getCancelPerson(), other.getCancelPerson()).append(getCancelTime(), other.getCancelTime())
				.append(getExportPerson(), other.getExportPerson()).append(getExportTime(), other.getExportTime()).append(getVerifyPerson(), other.getVerifyPerson())
				.append(getVerifyTime(), other.getVerifyTime()).append(getOrderState(), other.getOrderState()).append(getUserSatisfaction(), other.getUserSatisfaction())
				.append(getIsWarranty(), other.getIsWarranty()).append(getOrderType(), other.getOrderType()).append(getWithin24Hours(), other.getWithin24Hours())
				.append(getBasicSalary(), other.getBasicSalary()).append(getPositiveIncentive(), other.getPositiveIncentive())
				.append(getNegativeIncentive(), other.getNegativeIncentive()).append(getAppreciationComponents(), other.getAppreciationComponents())
				.append(getAppreciationMoney(), other.getAppreciationMoney()).isEquals();
	}
