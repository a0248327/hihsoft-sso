...
public class TsysUpload extends BaseEntity {
	...
	public TsysUpload(java.lang.String uploadid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Uploadid", getUploadid()).append("CreateMan", getCreateMan()).append("CreateTime", getCreateTime()).append("FileUrl", getFileUrl())
				.append("FileName", getFileName()).append("Flatid", getFlatid()).append("Remark", getRemark()).append("SecondName", getSecondName()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getUploadid()).append(getCreateMan()).append(getCreateTime()).append(getFileUrl()).append(getFileName()).append(getFlatid()).append(getRemark())
				.append(getSecondName()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TsysUpload == false)
			return false;
		if (this == obj)
			return true;
		TsysUpload other = (TsysUpload) obj;
		return new EqualsBuilder().append(getUploadid(), other.getUploadid()).append(getCreateMan(), other.getCreateMan()).append(getCreateTime(), other.getCreateTime())
				.append(getFileUrl(), other.getFileUrl()).append(getFileName(), other.getFileName()).append(getFlatid(), other.getFlatid()).append(getRemark(), other.getRemark())
				.append(getSecondName(), other.getSecondName()).isEquals();
	}
}
