...
public class TsysCodebuilder extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Codeid", getCodeid()).append("Pri", getPri()).append("Tablename", getTablename()).append("Fields", getFields())
				.append("Querycondition", getQuerycondition()).append("Fill", getFill()).append("Descript", getDescript()).append("Control", getControl()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getCodeid()).append(getPri()).append(getTablename()).append(getFields()).append(getQuerycondition()).append(getFill()).append(getDescript())
				.append(getControl()).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getCodeid(), other.getCodeid()).append(getPri(), other.getPri()).append(getTablename(), other.getTablename()).append(getFields(), other.getFields())
				.append(getQuerycondition(), other.getQuerycondition()).append(getFill(), other.getFill()).append(getDescript(), other.getDescript())
