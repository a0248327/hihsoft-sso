...
public class TsysAreacoding extends BaseEntity {
	...
	private static final long serialVersionUID = -4269271271738388190L;
	// alias
	...
	public TsysAreacoding(java.lang.String areacodingid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Areacodingid", getAreacodingid()).append("Areacode", getAreacode()).append("Areaname", getAreaname()).append("Areatype", getAreatype())
				.append("Parentarea", getParentarea()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getAreacodingid()).append(getAreacode()).append(getAreaname()).append(getAreatype()).append(getParentarea()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TsysAreacoding == false)
			return false;
		if (this == obj)
			return true;
		TsysAreacoding other = (TsysAreacoding) obj;
		return new EqualsBuilder().append(getAreacodingid(), other.getAreacodingid()).append(getAreacode(), other.getAreacode()).append(getAreaname(), other.getAreaname())
				.append(getAreatype(), other.getAreatype()).append(getParentarea(), other.getParentarea()).isEquals();
	}
}
