...
public class TaclDutyuser extends BaseEntity {
	...
	public TaclDutyuser(java.lang.String dutyuserid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Roleuserid", getDutyuserid()).append("Userid", getUserid()).append("Roleid", getDutyid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getDutyuserid()).append(getUserid()).append(getDutyid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TaclDutyuser == false)
			return false;
		if (this == obj)
			return true;
		TaclDutyuser other = (TaclDutyuser) obj;
		return new EqualsBuilder().append(getDutyuserid(), other.getDutyuserid()).append(getUserid(), other.getUserid()).append(getDutyid(), other.getDutyid()).isEquals();
	}
}
