...
public class TaclRoleuser extends BaseEntity {
	...
	public TaclRoleuser(java.lang.String roleuserid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Roleuserid", getRoleuserid()).append("Userid", getUserid()).append("Roleid", getRoleid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getRoleuserid()).append(getUserid()).append(getRoleid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TaclRoleuser == false)
			return false;
		if (this == obj)
			return true;
		TaclRoleuser other = (TaclRoleuser) obj;
		return new EqualsBuilder().append(getRoleuserid(), other.getRoleuserid()).append(getUserid(), other.getUserid()).append(getRoleid(), other.getRoleid()).isEquals();
	}
}
