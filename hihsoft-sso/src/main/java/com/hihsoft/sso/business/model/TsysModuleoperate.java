...
public class TsysModuleoperate extends BaseEntity {
	...
	public TsysModuleoperate(java.lang.String operateid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Operateid", getOperateid()).append("Moduleid", getModuleid()).append("Operatename", getOperatename()).append("Operateno", getOperateno())
				.toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getOperateid()).append(getModuleid()).append(getOperatename()).append(getOperateno()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TsysModuleoperate == false)
			return false;
		if (this == obj)
			return true;
		TsysModuleoperate other = (TsysModuleoperate) obj;
		return new EqualsBuilder().append(getOperateid(), other.getOperateid()).append(getModuleid(), other.getModuleid()).append(getOperatename(), other.getOperatename())
				.append(getOperateno(), other.getOperateno()).isEquals();
	}
}
