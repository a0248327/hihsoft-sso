...
public class TsysOrg extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Orgid", getOrgid()).append("Orgno", getOrgno()).append("Orgname", getOrgname()).append("Parentorgid", getParentorgid())
				.append("Addr", getAddr()).append("Website", getWebsite()).append("Telephone", getTelephone()).append("Fax", getFax()).append("Orgtype", getOrgtype())
				.append("Email", getEmail()).append("Orgdesc", getOrgdesc()).append("Orgstate", getOrgstate()).append("OrgClass", getOrgClass())
				.append("OrgShortname", getOrgShortname()).append("OrgKind", getOrgKind()).append("CorpMan", getCorpMan()).append("Mobile", getMobile()).toString();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder().append(getOrgid()).append(getOrgno()).append(getOrgname()).append(getParentorgid()).append(getAddr()).append(getWebsite()).append(getTelephone())
				.append(getFax()).append(getOrgtype()).append(getEmail()).append(getOrgdesc()).append(getOrgstate()).append(getOrgClass()).append(getOrgShortname())
				.append(getOrgKind()).append(getCorpMan()).append(getMobile()).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getOrgid(), other.getOrgid()).append(getOrgno(), other.getOrgno()).append(getOrgname(), other.getOrgname())
				.append(getParentorgid(), other.getParentorgid()).append(getAddr(), other.getAddr()).append(getWebsite(), other.getWebsite())
				.append(getTelephone(), other.getTelephone()).append(getFax(), other.getFax()).append(getOrgtype(), other.getOrgtype()).append(getEmail(), other.getEmail())
				.append(getOrgdesc(), other.getOrgdesc()).append(getOrgstate(), other.getOrgstate()).append(getOrgClass(), other.getOrgClass())
				.append(getOrgShortname(), other.getOrgShortname()).append(getOrgKind(), other.getOrgKind()).append(getCorpMan(), other.getCorpMan())
