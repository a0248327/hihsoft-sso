...
public class TsysTreeprivilege extends BaseEntity {
	...
	public TsysTreeprivilege(java.lang.String treeid) {
		this.treeid = treeid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Treeid", getTreeid()).append("Orgid", getOrgid()).append("Userid", getUserid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getTreeid()).append(getOrgid()).append(getUserid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TsysTreeprivilege == false)
			return false;
		if (this == obj)
			return true;
		TsysTreeprivilege other = (TsysTreeprivilege) obj;
		return new EqualsBuilder().append(getTreeid(), other.getTreeid()).append(getOrgid(), other.getOrgid()).append(getUserid(), other.getUserid()).isEquals();
	}
}
