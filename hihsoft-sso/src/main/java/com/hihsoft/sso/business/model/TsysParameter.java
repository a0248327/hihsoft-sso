...
public class TsysParameter extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Paraid", getParaid()).append("Isdefault", getIsdefault()).append("Paraname", getParaname()).append("Parano", getParano())
				.append("ParaClass", getParaClass()).append("ParaKey", getParaKey()).append("ParaType", getParaType()).append("ParaOrder", getParaOrder()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getParaid()).append(getIsdefault()).append(getParaname()).append(getParano()).append(getParaClass()).append(getParaKey()).append(getParaType())
				.append(getParaOrder()).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getParaid(), other.getParaid()).append(getIsdefault(), other.getIsdefault()).append(getParaname(), other.getParaname())
				.append(getParano(), other.getParano()).append(getParaClass(), other.getParaClass()).append(getParaKey(), other.getParaKey())
				.append(getParaType(), other.getParaType()).append(getParaOrder(), other.getParaOrder()).isEquals();
	}
}
