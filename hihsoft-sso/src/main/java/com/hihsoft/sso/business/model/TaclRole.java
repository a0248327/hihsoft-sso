...
public class TaclRole extends BaseEntity {
	...
	public TaclRole(java.lang.String roleid) {
		this.roleid = roleid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Roleid", getRoleid()).append("Remark", getRemark()).append("Rolename", getRolename()).append("Roletype", getRoletype())
				.append("Orgid", getOrgid()).append("RoleSort", getRoleSort()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getRoleid()).append(getRemark()).append(getRolename()).append(getRoletype()).append(getOrgid()).append(getRoleSort()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TaclRole == false)
			return false;
		if (this == obj)
			return true;
		TaclRole other = (TaclRole) obj;
		return new EqualsBuilder().append(getRoleid(), other.getRoleid()).append(getRemark(), other.getRemark()).append(getRolename(), other.getRolename())
				.append(getRoletype(), other.getRoletype()).append(getOrgid(), other.getOrgid()).append(getRoleSort(), other.getRoleSort()).isEquals();
	}
}
