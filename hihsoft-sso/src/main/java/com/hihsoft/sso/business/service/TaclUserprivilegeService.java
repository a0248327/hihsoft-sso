...
/**
 * Title:用户分配权限的服务 Description: Copyright: Copyright (c) 2013
...
public interface TaclUserprivilegeService extends BaseService {
	...
	public int getTaclUserprivilegeDataTotalNum(Object[] filter) throws ServiceException;
	...
	public List<?> getTaclUserprivilegePageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclUserprivilegePageDataByMap(Map<String, Object> filter, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTaclUserprivilegeValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTaclUserprivilegeValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
