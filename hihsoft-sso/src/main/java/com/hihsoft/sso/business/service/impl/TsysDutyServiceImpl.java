...
public class TsysDutyServiceImpl extends BaseServiceImpl implements TsysDutyService {
	...
	public List<?> getTsysDutyPageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysDutyPageDataByMap(Map<String, Object> filter, int page_size, int pageNo) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TSYSDUTY_HQL.toString(), filter, page_size, pageNo);
	}
	 ...
	 */
	public List<?> getTsysDutyValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysDutyValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
		return baseDAO.getValueObjectByDetachedCriterias(detachedCriteria, arg1, arg2);
	}

	@Override
	public List<TaclDutyuser> getUserAllByDutyId(String dutyid) throws ServiceException {
		String hql = "from TaclDutyuser d where d.userid in " + "(select du.userid from TaclDutyuser du where du.dutyid = ?)";
	...
	@Override
	public List<TaclDutyuser> getTaclDutyuserByDutyid(final String dutyid) throws ServiceException {
		return baseDAO.doInHibernate(new HibernateCallback<List<TaclDutyuser>>() {
			@Override
			public List<TaclDutyuser> doInHibernate(Session session) throws HibernateException, SQLException {
				TsysDuty tsysDuty = null;
