...
/**
 * Title:数据(附件)上传服务 Description: Copyright: Copyright (c) 2013
...
public interface TsysUploadService extends BaseService {
	...
	public int getTsysUploadDataTotalNum(Object[] filter) throws ServiceException;
	...
	public List<?> getTsysUploadPageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysUploadPageDataByMap(Map<String, Object> filter, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTsysUploadValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysUploadValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
