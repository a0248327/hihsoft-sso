...
public class TaclUserprivilege extends BaseEntity {
	...
	public TaclUserprivilege(java.lang.String userprviid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Userprviid", getUserprviid()).append("Moduleid", getModuleid()).append("Operateid", getOperateid()).append("Userid", getUserid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getUserprviid()).append(getModuleid()).append(getOperateid()).append(getUserid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TaclUserprivilege == false)
			return false;
		if (this == obj)
			return true;
		TaclUserprivilege other = (TaclUserprivilege) obj;
		return new EqualsBuilder().append(getUserprviid(), other.getUserprviid()).append(getModuleid(), other.getModuleid()).append(getOperateid(), other.getOperateid())
