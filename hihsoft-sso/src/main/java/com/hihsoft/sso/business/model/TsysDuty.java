...
public class TsysDuty extends BaseEntity {
	...
	public TsysDuty(java.lang.String dutyid) {
		this.dutyid = dutyid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Dutyid", getDutyid()).append("Dutyname", getDutyname()).append("Remark", getRemark()).append("ParentDutyid", getParentDutyid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getDutyid()).append(getDutyname()).append(getRemark()).append(getParentDutyid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (!(obj instanceof TsysDuty))
			return false;
		if (this == obj)
			return true;
		TsysDuty other = (TsysDuty) obj;
		return new EqualsBuilder().append(getDutyid(), other.getDutyid()).append(getDutyname(), other.getDutyname()).append(getRemark(), other.getRemark())
				.append(getParentDutyid(), other.getParentDutyid()).isEquals();
	}
}
