...
public class TsysParameterServiceImpl extends BaseServiceImpl implements TsysParameterService {
	/************ 查询所有的TSYSPARAMETER ******************/
	 ...
	 */
	public void saveOrUpdateTsysParameter(TsysParameter tsysParameter) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public TsysParameter getTsysParameterById(String id) throws ServiceException {
		TsysParameter tsysParameter = null;
		List<?> list = baseDAO.getValueObjectsByHQL(TSYSPARAMETERById_HQL, new Object[] { id });
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysParameterByHQL(String hql, Object[] object) throws ServiceException {
	...
	public int getTsysParameterDataTotalNum(String hql, Object[] object) throws ServiceException {
	...
	public List<?> getTsysParameterPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysParameterPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysParameterValueObjectBySQL(String sql, Object[] object) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysParameterValueObjectByNameQuery(String queryName, Object[] object) throws ServiceException {
	 ...
	 */
	public List<?> getTsysParameterValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysParameterValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
	...
	public void saveFillParamMap(String paraType) throws ServiceException {
		...
		if (paraType != null && !paraType.trim().equals("")) {
			...
			list = baseDAO.getValueObjectsByHQL(paramHql.toString(), new Object[] { paraType });
			if (list.size() > 0) {
	...
	private Object[] getTsysParameterHql(Object[] object) {
		...
		StringBuffer paramHql = new StringBuffer("from TsysParameter param where 1=1");
