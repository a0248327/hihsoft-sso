...
public class TaclRoleprivilege extends BaseEntity {
	...
	private static final long serialVersionUID = -1029036421184839945L;
	// alias
	...
	public TaclRoleprivilege(java.lang.String rid) {
		this.rid = rid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Rid", getRid()).append("Moduleid", getModuleid()).append("Operateid", getOperateid()).append("Roleid", getRoleid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getRid()).append(getModuleid()).append(getOperateid()).append(getRoleid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TaclRoleprivilege == false)
			return false;
		if (this == obj)
			return true;
		TaclRoleprivilege other = (TaclRoleprivilege) obj;
		return new EqualsBuilder().append(getRid(), other.getRid()).append(getModuleid(), other.getModuleid()).append(getOperateid(), other.getOperateid())
