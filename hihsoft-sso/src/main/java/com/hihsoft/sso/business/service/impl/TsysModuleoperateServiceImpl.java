...
public class TsysModuleoperateServiceImpl extends BaseServiceImpl implements TsysModuleoperateService {
	 ...
	 */
	public void saveOrUpdateTsysModuleoperate(TsysModuleoperate tsysModuleoperate) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public TsysModuleoperate getTsysModuleoperateById(String id) throws ServiceException {
		TsysModuleoperate tsysModuleoperate = null;
		List<?> list = baseDAO.getValueObjectsByHQL(TSYSMODULEOPERATEById_HQL, new Object[] { id });
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysModuleoperateByHQL(String hql, Object... object) throws ServiceException {
	...
	public int getTsysModuleoperateDataTotalNum(String hql, Object... object) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysModuleoperatePageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysModuleoperateValueObjectBySQL(String sql, Object... object) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysModuleoperateValueObjectByNameQuery(String queryName, Object... object) throws ServiceException {
	 ...
	 */
	public List<?> getTsysModuleoperateValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysModuleoperateValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
