...
public class TaclRoleprivilegeServiceImpl extends BaseServiceImpl implements TaclRoleprivilegeService {
	 ...
	 */
	public void saveOrUpdateTaclRoleprivilege(TaclRoleprivilege taclRoleprivilege) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public TaclRoleprivilege getTaclRoleprivilegeById(String id) throws ServiceException {
		TaclRoleprivilege taclRoleprivilege = null;
		List<?> list = baseDAO.getValueObjectsByHQL(TACLROLEPRIVILEGEById_HQL, new Object[] { id });
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleprivilegeByHQL(String hql, Object[] object) throws ServiceException {
	...
	public int getTaclRoleprivilegeDataTotalNum(String hql, Object[] object) throws ServiceException {
	...
	public List<?> getTaclRoleprivilegePageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleprivilegePageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleprivilegeValueObjectBySQL(String sql, Object[] object) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleprivilegeValueObjectByNameQuery(String queryName, Object[] object) throws ServiceException {
	 ...
	 */
	public List<?> getTaclRoleprivilegeValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTaclRoleprivilegeValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
	...
	public boolean saveRoleSet(String roleId, String moduleSet) throws ServiceException {
		...
		// hql =
		// "delete from TsysDataprivilege where roleid='"+roleId+"'";
		// executeHQL(hql);
