...
public class TsysModuleinfo extends BaseEntity {
	...
	public TsysModuleinfo(String moduleid) {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Moduleid", getModuleid()).append("Flatid", getFlatid()).append("Linkedaddr", getLinkedaddr()).append("Moduleclass", getModuleclass())
				.append("Moduledesc", getModuledesc()).append("Moduleicon", getModuleicon()).append("Modulename", getModulename()).append("Moduleno", getModuleno())
				.append("Parentmoduleid", getParentmoduleid()).append("Sortnum", getSortnum()).append("Leaf", getLeaf()).append("Tabsort", getTabsort()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getModuleid()).append(getFlatid()).append(getLinkedaddr()).append(getModuleclass()).append(getModuledesc()).append(getModuleicon())
				.append(getModulename()).append(getModuleno()).append(getParentmoduleid()).append(getSortnum()).append(getLeaf()).append(getTabsort()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TsysModuleinfo == false)
			return false;
		if (this == obj)
			return true;
		TsysModuleinfo other = (TsysModuleinfo) obj;
		return new EqualsBuilder().append(getModuleid(), other.getModuleid()).append(getFlatid(), other.getFlatid()).append(getLinkedaddr(), other.getLinkedaddr())
				.append(getModuleclass(), other.getModuleclass()).append(getModuledesc(), other.getModuledesc()).append(getModuleicon(), other.getModuleicon())
				.append(getModulename(), other.getModulename()).append(getModuleno(), other.getModuleno()).append(getParentmoduleid(), other.getParentmoduleid())
				.append(getSortnum(), other.getSortnum()).append(getLeaf(), other.getLeaf()).append(getTabsort(), other.getTabsort()).isEquals();
	}
}
