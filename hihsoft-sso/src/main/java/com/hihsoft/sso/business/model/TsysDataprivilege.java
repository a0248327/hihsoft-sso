...
public class TsysDataprivilege extends BaseEntity {
	...
	private static final long serialVersionUID = -2361375530687668478L;
	// alias
	...
	public TsysDataprivilege(java.lang.String dataid) {
		this.dataid = dataid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Dataid", getDataid()).append("Roleid", getUserid()).append("Orgid", getOrgid()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getDataid()).append(getUserid()).append(getOrgid()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof TsysDataprivilege == false)
			return false;
		if (this == obj)
			return true;
		TsysDataprivilege other = (TsysDataprivilege) obj;
		return new EqualsBuilder().append(getDataid(), other.getDataid()).append(getUserid(), other.getUserid()).append(getOrgid(), other.getOrgid()).isEquals();
	}
}
