...
public class TbusinessOrderServiceImpl extends BaseServiceImpl implements TbusinessOrderService {
	...
	public int getTbusinessOrderDataTotalNum(Object[] filter) throws ServiceException {
	...
	public List getTbusinessOrderPageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List getTbusinessOrderPageDataByMap(Map filter, int page_size, int pageNo) throws ServiceException {
	 ...
	 */
	public List getTbusinessOrderValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List getTbusinessOrderValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
