...
public class TaclUserinfoServiceImpl extends BaseServiceImpl implements TaclUserinfoService {
	/************ 查询所有的TACLUSERINFO ******************/
	...
	private static final StringBuffer QUERY_TACLUSERINFO_HQL = new StringBuffer(" from TaclUserinfo taclUserinfo where 1=1");

	/************ 通过不同的条件组合，利用JDBC SQL查询TACLUSERINFO ******************/
	private static final StringBuffer QUERY_TACLUSERINFO_SQL = new StringBuffer("select * from T_ACL_USERINFO t where 1=1");
	 ...
	 */
	public void saveOrUpdateTaclUserinfo(TaclUserinfo taclUserinfo) throws ServiceException {
	...
	public void deleteTaclUserinfo(String ids) throws ServiceException {
		...
		if (ids != null && !"".equals(ids)) {
			...
			for (String id : arr) {
				...
				// list.add(obj);
				// executeHQL("delete from TsysDataprivilege where userid=?",
				// id);
				// executeHQL("delete from TaclRoleuser where userid=?",
				// id);
			}
		}
		// deleteBatchVO(list);
	...
	public TaclUserinfo getTaclUserinfoById(String id) throws ServiceException {
		...
		List<?> list = baseDAO.getValueObjectsByHQL(TACLUSERINFOById_HQL, new Object[] { id });
	...
	public List<?> getTaclUserinfoByArray(Object[] filter) throws ServiceException {
		return baseDAO.getValueObjectsByHQL(QUERY_TACLUSERINFO_HQL.toString(), filter);
	}
	...
	public int getTaclUserinfoDataTotalNum(Object[] filter) throws ServiceException {
		return baseDAO.getDataTotalNum(QUERY_TACLUSERINFO_HQL.toString(), filter);
	}
	...
	public List<?> getTaclUserinfoByMap(Map<String, Object> filter) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TACLUSERINFO_HQL.toString(), filter);
	}
	...
	public List<?> getTaclUserinfoPageDataByArray(Object[] filter, int page_size, int pageNo) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TACLUSERINFO_HQL.toString(), filter, page_size, pageNo);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclUserinfoPageDataByMap(Map<String, Object> filter, int page_size, int pageNo) throws ServiceException {
		return baseDAO.getPageDataByHQL(QUERY_TACLUSERINFO_HQL.toString(), filter, page_size, pageNo);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclUserinfoValueObjectWithSQLByArray(Object[] filter) throws ServiceException {
		return baseDAO.getValueObjectBySQL(QUERY_TACLUSERINFO_SQL.toString(), filter);
	}
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclUserinfoValueObjectByNameQuery(String queryName, Object[] filter) throws ServiceException {
	 ...
	 */
	public List<?> getTaclUserinfoValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTaclUserinfoValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
	...
	public String getPrivilegeTree(final String userId, final String curUserId) throws ServiceException {
		...
		List<Map<String, Object>> map = baseDAO.doInHibernate(new HibernateCallback<List<Map<String, Object>>>() {
			...
			public List<Map<String, Object>> doInHibernate(Session session) throws HibernateException, SQLException {
				...
				List<TsysFlat> flats = session.createSQLQuery(sql).addEntity(TsysFlat.class).setString("USERID", curUserId).list();
				...
				for (TsysFlat flat : flats) {
					...
					if (moduleinfos.size() > 0) {
						...
						for (TsysModuleinfo info : moduleinfos) {
							...
							if (!modules.containsKey(info.getModuleid()))
								continue;
	...
	protected void buildModuleTree(TsysModuleinfo info, Map<String, Object> child, Map<String, Object> modules, Map<String, Object> assinged, Map<String, Object> privileges)
			throws ServiceException {
		if (!modules.containsKey(info.getModuleid()))
			return;
		...
		for (TsysModuleoperate oper : opers) {
			if (modules.get(oper.getOperateid()) == null)
				continue;
	...
	@Override
	public List<Map<String, Object>> getModuleTree(final String userId) throws ServiceException {
	...
	@Override
	public boolean saveOrUpdateTaclDutyUser(String userId, String duty) throws ServiceException {
	...
	public List<TsysDuty> getDutyAllByUserId(String userId) throws ServiceException {
		String hql = "from TsysDuty d where d.dutyid in " + "(select du.dutyid from TaclDutyuser du where du.userid = ?)";
		@SuppressWarnings("unchecked")
