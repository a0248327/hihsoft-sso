...
public class TsysFlat extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Flatid", getFlatid()).append("Flatcode", getFlatcode()).append("Remark", getRemark()).append("Flaturl", getFlaturl())
				.append("Shortname", getShortname()).append("Flatdesc", getFlatdesc()).append("Flatname", getFlatname()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getFlatid()).append(getFlatcode()).append(getRemark()).append(getFlaturl()).append(getShortname()).append(getFlatdesc()).append(getFlatname())
				.toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getFlatid(), other.getFlatid()).append(getFlatcode(), other.getFlatcode()).append(getRemark(), other.getRemark())
				.append(getFlaturl(), other.getFlaturl()).append(getShortname(), other.getShortname()).append(getFlatdesc(), other.getFlatdesc())
