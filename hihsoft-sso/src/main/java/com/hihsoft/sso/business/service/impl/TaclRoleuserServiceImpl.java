...
public class TaclRoleuserServiceImpl extends BaseServiceImpl implements TaclRoleuserService {
	/************ 查询所有的TACLROLEUSER ******************/
	 ...
	 */
	public void saveOrUpdateTaclRoleuser(TaclRoleuser taclRoleuser) throws ServiceException {
	...
	public TaclRoleuser getTaclRoleuserById(String id) throws ServiceException {
		...
		List<?> list = baseDAO.getValueObjectsByHQL(TACLROLEUSERById_HQL, new Object[] { id });
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleuserByHQL(String hql, Object[] object) throws ServiceException {
	...
	public int getTaclRoleuserDataTotalNum(String hql, Object[] object) throws ServiceException {
	...
	public List<?> getTaclRoleuserPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleuserPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleuserValueObjectBySQL(String sql, Object[] object) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTaclRoleuserValueObjectByNameQuery(String queryName, Object[] object) throws ServiceException {
	 ...
	 */
	public List<?> getTaclRoleuserValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTaclRoleuserValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException {
