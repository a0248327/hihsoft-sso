...
/**
 * Title:生成源代码的服务 Description: Copyright: Copyright (c) 2013
...
public interface TsysCodebuilderService extends BaseService {
	...
	public int getTsysCodebuilderDataTotalNum(String hql, Object[] object) throws ServiceException;
	...
	public List<?> getTsysCodebuilderPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysCodebuilderPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTsysCodebuilderValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysCodebuilderValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
