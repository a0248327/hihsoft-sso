...
/**
 * Title:模块(菜单)定义的服务 Description: Copyright: Copyright (c) 2013
...
public interface TsysModuleinfoService extends BaseService {
	...
	public int getTsysModuleinfoDataTotalNum(String hql, Object[] object) throws ServiceException;
	...
	public List<?> getTsysModuleinfoPageDataByHQL(String hql, Object[] object, int page_size, int pageNo) throws ServiceException;
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTsysModuleinfoPageDataByHQL(String hql, Map<String, Object> obj, int page_size, int pageNo) throws ServiceException;
	 ...
	 */
	public List<?> getTsysModuleinfoValueObjectByDetachedCriteria(DetachedCriteria detachedCriteria) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public List<?> getTsysModuleinfoValueObjectByDetachedCriterias(DetachedCriteria detachedCriteria, int arg1, int arg2) throws ServiceException;
