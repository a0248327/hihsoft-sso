...
/**
 * <p>
 * Title:所有页面控制类的 基类，可以考虑继承它、获取更多约定的功能 Description:基于命名规则的CRUD Controller基类
 * Copyright: Copyright (c) 2013 Company:hihsoft.co.,ltd
 * 
...
public class javahihBaseController extends BaseController {
	...
	public ModelAndView index(final HttpServletRequest request, final HttpServletResponse response) throws ControllerException {
	...
	public ModelAndView list(final HttpServletRequest request, final HttpServletResponse response) throws ControllerException {
	...
	public ModelAndView add(final HttpServletRequest request, final HttpServletResponse response) throws ControllerException {
	...
	public ModelAndView save(final HttpServletRequest request, final HttpServletResponse response) throws ControllerException {
	...
	public ModelAndView view(final HttpServletRequest request, final HttpServletResponse response) throws ControllerException {
		final ModelAndView mav = new ModelAndView(v_form);
		mav.addAllObjects(referenceData(request));
	...
	public ModelAndView delete(final HttpServletRequest request, final HttpServletResponse response) throws ControllerException {
		final ModelAndView mav = new ModelAndView(v_success);
		mav.addAllObjects(referenceData(request));
	 ...
	 *                 the ControllerException
	 */
	protected void list(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView mav) throws ControllerException {
	}
	 ...
	 *                 the ControllerException
	 */
	protected void add(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView mav) throws ControllerException {
	}
	 ...
	 *                 the ControllerException
	 */
	protected void view(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView mav) throws ControllerException {
	}
	 ...
	 *                 the ControllerException
	 */
	protected void save(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView mav, final boolean isNew) throws ControllerException {
	}
	 ...
	 *                 the ControllerException
	 */
	protected void delete(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView mav) throws ControllerException {
	}
	 ...
	 *                the model
	 */
	protected void referenceData(final HttpServletRequest request, final Map<String, Object> model) {
	...
	protected ModelAndView bindError(final HttpServletRequest request, final BindingResult result, final ModelAndView mav, final String viewName) {
	 ...
	 */
	@Override
	protected BindingResult bindObject(final HttpServletRequest request, final Object command) throws ControllerException {
		...
		if (command instanceof AuditableEntity) {
			...
			final TaclUserinfo user = (TaclUserinfo) request.getSession().getAttribute(Consts.USER_INFO);// 修改从会话中获取用户信息add
															// by
															// zhujw
	 ...
	 */
	protected String uploadImageToFile(final HttpServletRequest request, final String uploadDir, final String parameterName) throws IOException {
		...
		try {
			...
			return null; // only for testcast
					// 中,mockservlet不能转为MultipartRequest
		}
	...
	public ModelAndView getOrgTree(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
	...
	public void getAssignedOrgTree(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
		String userId = getParam(request, "userId");
		String orgClass = getParam(request, "orgClass");
	...
	public ModelAndView getModuleTree(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
		...
		try {
			...
			if (StringHelpers.notNull(roleId)) {
				...
				tree = baseService.getModuleTree(flatId, oper);
	...
	public List<TsysParameter> getRoleType(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
	...
	public boolean isGroup(HttpServletRequest request, HttpServletResponse response) {
		TsysOrg org = (TsysOrg) request.getSession().getAttribute(Consts.USER_DEFAULT_ORG);
	...
	public ModelAndView changePwd(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
	...
	public void getHelpMenu(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
	...
	public void getDutyTree(HttpServletRequest request, HttpServletResponse response) throws ControllerException {
		String userId = getParam(request, "userId");
