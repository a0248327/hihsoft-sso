...
/**
 * <p>
 * Title:框架持久化层DAO接口实现类基类 Description:支持各种过滤条件：数组、Map Copyright: Copyright (c)
 * 2013 Company:hihsoft.co.,ltd
 * 
...
public class BaseDAOImpl extends HibernateDaoSupport implements BaseDAO {
	...
	@Override
	public void executeQueryByHQL(String hql, Object... params) throws DataAccessException {
	...
	@Override
	public void deleteVO(final BaseEntity vo, final String id) throws DataAccessException {
	 ...
	 */
	@Override
	public String saveOrUpdateVOAndReturnId(final BaseEntity vo) throws DataAccessException {
	...
	@Override
	public int getDataTotalNum(final String hql, final String arg1) throws DataAccessException {
	...
	public int getTotalNumBySQL(String sql, Object... args) throws DataAccessException {
		int amount = 0;
		final Session session = getSession(); // 取得session
		Query query = session.createSQLQuery("select count(*)  from (" + sql + ") count_table"); // 查询符合条件数据
	...
	@Override
	public int getDataTotalNum(final String hql, final Object obj) throws DataAccessException {

		int amount = 0;
		final Session session = getSession(); // 取得session
		Query query = null;
		final int start = hql.toLowerCase().indexOf("from");
		query = session.createQuery("select count(*) from " + hql.substring(start + 4)).setProperties(obj); // 查询符合条件数据
		final List<?> list = query.list();
		if (!list.isEmpty()) {
			amount = Integer.parseInt(list.get(0).toString());
	...
	@Override
	public int getDataTotalNum(String hql, Object... filter) throws DataAccessException {
	...
	@Override
	public int getDataTotalNum(final BaseEntity vo, final String whereClause) throws DataAccessException {
	...
	@Override
	public List<?> getPageDataByHQL(String hql, int page_size, int pageNo, Object... args) throws DataAccessException {
	...
	@Override
	public List<?> getPageDataByHQL(final String hql, final Map<String, Object> filter) throws DataAccessException {
	...
	@Override
	public List<?> getPageDataByHQL(final String hql, final int page_size, int pageNo) throws DataAccessException {
		List<?> list = new ArrayList<Object>();
		int total_page = 0; // 总页数
	...
	@Override
	public List<?> getPageDataByHQL(final String hql, final String arg1, final int page_size, int pageNo) throws DataAccessException {
	...
	@Override
	public List<?> getPageDataByHQL(final String hql, final Object obj, final int page_size, int pageNo) throws DataAccessException {
	...
	@Override
	public List<?> getPageDataByHQL(final String hql, final Map<String, Object> filter, final int page_size, int pageNo) throws DataAccessException {
	...
	@Override
	public List<?> getPageDataByHQL(final String hql, final int page_size, int pageNo, final int total_num) throws DataAccessException {
	...
	@Override
	public BaseEntity getVO(final BaseEntity vo, final String id) throws DataAccessException {
		final BaseEntity BaseEntity = getHibernateTemplate().get(vo.getClass(), id);
	...
	@Override
	public List<?> getValueObjectBySQL(final String sql) throws DataAccessException {
		final Session session = getSession(); // 取得session
		Query query = null;
	...
	@Override
	public List<?> getValueObjectBySQL(final String sql, Object... args) throws DataAccessException {
		Session session = getSession();
		Query query = null;
	...
	@Override
	public List<?> getValueObjectsByHQL(final String hql, Object... object) throws DataAccessException {

		return getHibernateTemplate().find(hql, object);
	}

	@Override
	public void saveOrUpdateBatchVO(final List<?> dataList) throws DataAccessException {
	 ...
	 * 带审计对象
	 */
	public void saveOrMergeVO(final BaseAuditEntity vo) throws DataAccessException {
	 ...
	 * <query name="queryUser"> <![CDATA[ select user.name from TAclUser as
	 * user where user.userid=3 ]]> </query>
	 */
	@Override
	public List<?> getValueObjectByNameQuery(final String queryName) throws DataAccessException {
		return getHibernateTemplate().findByNamedQuery(queryName);
	}

	@Override
	public List<?> getValueObjectByNameQuery(final String queryName, final Object object) throws DataAccessException {
		return getHibernateTemplate().findByNamedQuery(queryName, object);
	}

	@Override
	public List<?> getValueObjectByNameQuery(final String queryName, final Object... filter) throws DataAccessException {
		return getHibernateTemplate().findByNamedQuery(queryName, filter);
	}

	@Override
	public List<?> getValueObjectByDetachedCriteria(final DetachedCriteria detachedCriteria) throws DataAccessException {
		return getHibernateTemplate().findByCriteria(detachedCriteria);
	}

	@Override
	public List<?> getValueObjectByDetachedCriterias(final DetachedCriteria detachedCriteria, final int arg1, final int arg2) throws DataAccessException {
		return getHibernateTemplate().findByCriteria(detachedCriteria, arg1, arg2);
	}

	@Override
	public List<?> getPageDataBySQL(String sql, int page_size, int pageNo, Object... args) throws DataAccessException {
		List<?> list = new ArrayList<Object>();
		int total_page = 0; // 总页数
	...
	@Override
	public List<?> getPageDataBySQL(final String sql, final int page_size, int pageNo) throws DataAccessException {
	...
	public List<?> getFrontPage(final Page page) throws DataAccessException {
		return getHibernateTemplate().executeFind(new HibernateCallback<List<?>>() {
			@Override
			public List<?> doInHibernate(final Session s) throws HibernateException, SQLException {
	...
	@Override
	public <T extends BaseEntity> T getBean(Class<T> type, Serializable id) throws DataAccessException {
		return getHibernateTemplate().get(type, id);
	}

	@SuppressWarnings("unchecked")
	@Override
	public <T> List<T> loadByField(Class<T> type, String field, Object value) throws DataAccessException {
		String hql = "from " + type.getName().substring(type.getName().lastIndexOf(".") + 1) + " where " + field + "=?";
		return getHibernateTemplate().find(hql, value);
	}

	@SuppressWarnings("unchecked")
	@Override
	public <T> List<T> getPageDateBySQL(Class<T> entity, String sql, int pageSize, int pageNo, Object... args) throws DataAccessException {
	...
	@Override
	public List<Map<String, Object>> queryForListByHQL(final String hql, final Object... args) throws DataAccessException {
			...
			public List<Map<String, Object>> doInHibernate(Session session) throws HibernateException, SQLException {
				...
				for (Object row : datas) {
					...
					if (row.getClass().isArray()) {
						...
						for (int i = 0; i < length && keys.length == length; i++) {
	...
	@Override
	public List<Map<String, Object>> queryForPagedListByHQL(final String hql, final int page, final int rows, final Object... args) throws DataAccessException {
		return getHibernateTemplate().execute(new HibernateCallback<List<Map<String, Object>>>() {
			public List<Map<String, Object>> doInHibernate(Session session) throws HibernateException, SQLException {
				Query query = session.createQuery(hql);
				...
				String[] keys = query.getReturnAliases();
				List<?> datas = query.setMaxResults(rows).setFirstResult((page - 1) * rows).list();
				List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
				for (Object row : datas) {
					Map<String, Object> map = new HashMap<String, Object>();
					if (row.getClass().isArray()) {
